...
final class Version20220617225428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE login_activity (id INT NOT NULL, related_user_id INT NOT NULL, connected_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ip_address BYTEA NOT NULL, PRIMARY KEY(id))');
