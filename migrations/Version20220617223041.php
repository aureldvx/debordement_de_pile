...
final class Version20220617223041 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "report" (id INT NOT NULL, uuid UUID NOT NULL, ticket_id INT DEFAULT NULL, comment_id INT DEFAULT NULL, author_id INT NOT NULL, description TEXT NOT NULL, enabled BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, resolved_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN report.uuid IS \'(DC2Type:uuid)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_C42F7784D17F50A6');
